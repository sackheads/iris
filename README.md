...
4.  `schedule_job`: Native API to register cron-like schedules (`minute`, `hour`, `weekday` or `weekdays` for multiple days, e.g. `[2,3,4,5,6]` for every weekday) or `intervalSeconds`.
