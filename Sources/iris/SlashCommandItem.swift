...
struct SlashCommandItem: Identifiable, Sendable, Equatable {
    ...
    static let allCommands: [SlashCommandItem] = [
        ...
        SlashCommandItem(id: "jobs", command: "/jobs", usage: "/jobs [ack <run id>|pause|resume|run|delete <name>]", description: "List background jobs, acknowledge a failed run, pause, resume, run, or delete a job"),
