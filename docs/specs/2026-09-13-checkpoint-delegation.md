...
- **`--no-parallel` was required to verify this work** while [#109](https://github.com/sackheads/iris/issues/109) was open; that is fixed and plain `swift test` is correct again.
